...
class ModuleCategoryOption extends BaseOptionTiles {
  @override
  _State createState() => _State();
}

class _State extends BaseOptionTilesState<ModuleCategoryOption> {

  @override
  Widget getMainTile() {
    print("moduleCategoryOption: getMainTile");
    listProcess.shuffle();
    ...
    if (listPosition == 0 || listPosition >= listOption1.length) {
      List<int> listCategories = [109,110,111,112,113];
